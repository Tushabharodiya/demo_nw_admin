            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <?php if($isBlogView){ ?>
                            <p><?php echo "You have total $countBlogs blogs."; ?></p>
                        <?php } ?>
                    </div>
                </div>
                <div class="nk-block-head-content">
                    <div class="toggle-wrap nk-block-tools-toggle">
                        <a href="<?php echo base_url(); ?>view-blogs/<?php echo $subCategoryID; ?>" class="btn btn-icon btn-trigger toggle-expand me-n1" data-target="pageMenu"><em class="icon ni ni-more-v"></em></a>
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <?php if($isBlogView){ ?>
                                    <li>
                                        <div class="dropdown">
                                            <a href="<?php echo base_url(); ?>view-blogs/<?php echo $subCategoryID; ?>" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-filter-alt"></em><span>Filtered By</span><em class="dd-indc icon ni ni-chevron-right"></em></a>
                                                    ...
                                                    <div class="row gx-6 gy-3">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-index" name="search_blogs_index" data-id="<?php echo $subCategoryID; ?>" data-placeholder="Select a index">
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsIndex == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsIndex == 'index')){
                                                                            $str.='selected';
                                                                    } ?> <option value="index"<?php echo $str; ?>>Index</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsIndex == 'noindex')){
                                                                            $str.='selected';
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-follow" name="search_blogs_follow" data-id="<?php echo $subCategoryID; ?>" data-placeholder="Select a follow">
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsFollow == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsFollow == 'follow')){
                                                                            $str.='selected';
                                                                    } ?> <option value="follow"<?php echo $str; ?>>Follow</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsFollow == 'nofollow')){
                                                                            $str.='selected';
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-status" name="search_blogs_status" data-id="<?php echo $subCategoryID; ?>" data-placeholder="Select a status">
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsStatus == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsStatus == 'publish')){
                                                                            $str.='selected';
                                                                    } ?> <option value="publish"<?php echo $str; ?>>Publish</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionBlogsStatus == 'unpublish')){
                                                                            $str.='selected';
                ...
                <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" name="search_blogs" value="<?php if(!empty($sessionBlogs)){ echo $sessionBlogs; } ?>" placeholder="Search..." autocomplete="off">
                        ...
                        <div class="nk-tb-list nk-tb-ulist">
                            <div class="table-responsive">
                                <table class="table table-tranx">
                                    ...
                                    <?php if($isBlogView){ ?>
                                        <?php if(!empty($viewBlogs)){ ?>
                                            <tbody>
                                                <?php foreach($viewBlogs as $data){ ?>
                                                    ...
                                                    <div class="modal-dialog modal-xl" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <a href="<?php echo base_url(); ?>view-blogs/<?php echo $subCategoryID; ?>" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                                    <em class="icon ni ni-cross"></em>
                                                                </a>
                                                            </div>
                                                            <div class="modal-body">
...
<script>
    document.getElementById('search-index').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-blogs'); ?>/' + subCategoryID,
            type: 'POST',
            data: { search_blogs_index: selectedIndex },
            success: function() {
...
<script>
    document.getElementById('search-follow').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-blogs'); ?>/' + subCategoryID,
            type: 'POST',
            data: { search_blogs_follow: selectedFollow },
            success: function() {
                window.location.href=window.location.href;
            }
        });
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-blogs'); ?>/' + subCategoryID,
            type: 'POST',
            data: { search_blogs_status: selectedStatus },
            success: function() {
                window.location.href=window.location.href;
            }
        });
