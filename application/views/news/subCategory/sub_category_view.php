                ...
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <?php if($isSubCategoryView){ ?>
                            <p><?php echo "You have total $countSubCategory sub categories."; ?></p>
                        <?php } ?>
                    </div>
                </div>
                <div class="nk-block-head-content">
                    <div class="toggle-wrap nk-block-tools-toggle">
                        <a href="<?php echo base_url(); ?>view-sub-category" class="btn btn-icon btn-trigger toggle-expand me-n1" data-target="pageMenu"><em class="icon ni ni-more-v"></em></a>
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <?php if($isSubCategoryView){ ?>
                                    <li>
                                        <div class="dropdown">
                                            <a href="<?php echo base_url(); ?>view-sub-category" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-filter-alt"></em><span>Filtered By</span><em class="dd-indc icon ni ni-chevron-right"></em></a>
                                                    ...
                                                    <div class="row gx-6 gy-3">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-select" id="search-status" name="search_sub_category_status" data-placeholder="Select a status">
                                                                    <?php $str='';
                                                                        if(!empty($sessionSubCategoryStatus == 'all')){
                                                                            $str.='selected';
                                                                    } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionSubCategoryStatus == 'publish')){
                                                                            $str.='selected';
                                                                    } ?> <option value="publish"<?php echo $str; ?>>Publish</option>
                                                                    <?php $str='';
                                                                        if(!empty($sessionSubCategoryStatus == 'unpublish')){
                                                                            $str.='selected';
                ...
                <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" name="search_sub_category" value="<?php if(!empty($sessionSubCategory)){ echo $sessionSubCategory; } ?>" placeholder="Search..." autocomplete="off">
                                                    ...
                                                    <div class="modal-dialog modal-md" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <a href="<?php echo base_url(); ?>view-sub-category" class="close" data-bs-dismiss="modal" aria-label="Close">
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('view-sub-category'); ?>',
            type: 'POST',
            data: { search_sub_category_status: selectedStatus },
            success: function() {
